...
VALUES
	('bob','smith','423-324-2439'),
	('mary','jane','315-244-2352'),
	('kevin','johnson','124-234-1237'),
	('carry','swanson','554-258-8543'),
	('evan','jameson','324-786-2357')
;
...
SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_fname LIKE 'ke%';

SELECT persons_fname, persons_lname, persons_contact FROM tbl_persons WHERE persons_lname LIKE '_o%n';

UPDATE tbl_persons SET persons_fname = 'mark' WHERE persons_fname = 'bob';

SELECT persons_fname AS 'first name', persons_lname AS 'last name', persons_contact AS 'phone number' FROM tbl_persons WHERE persons_fname LIKE 'm%' ORDER BY persons_lname DESC;
...
CREATE TABLE tbl_species (
	...
	species_nutrition INT NOT NULL CONSTRAINT fk_nutrution_id FOREIGN KEY REFERENCES tbl_nutrition(nutrition_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
VALUES
	...
	('ghost bad',1,102,1,5007,2204,'care_2'),
